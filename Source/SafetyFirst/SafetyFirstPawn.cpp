...
#include "SafetyFirstWheelFront.h"
#include "SafetyFirstWheelRear.h"
...
const FName ASafetyFirstPawn::LookUpBinding("LookUp");
const FName ASafetyFirstPawn::LookRightBinding("LookRight");
const FName ASafetyFirstPawn::EngineAudioRPM("RPM");
...
ASafetyFirstPawn::ASafetyFirstPawn()
{
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = USafetyFirstWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = USafetyFirstWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = USafetyFirstWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = USafetyFirstWheelRear::StaticClass();
...
void ASafetyFirstPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &ASafetyFirstPawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &ASafetyFirstPawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &ASafetyFirstPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &ASafetyFirstPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &ASafetyFirstPawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ASafetyFirstPawn::OnResetVR); 
}

void ASafetyFirstPawn::MoveForward(float Val)
{
	GetVehicleMovementComponent()->SetThrottleInput(Val);

}

void ASafetyFirstPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void ASafetyFirstPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void ASafetyFirstPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void ASafetyFirstPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ASafetyFirstPawn::EnableIncarView(const bool bState)
{
...
void ASafetyFirstPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void ASafetyFirstPawn::OnResetVR()
{
#if HMD_MODULE_INCLUDED
...
void ASafetyFirstPawn::UpdateHUDStrings()
{
...
void ASafetyFirstPawn::SetupInCarHUD()
{
...
void ASafetyFirstPawn::UpdatePhysicsMaterial()
{
